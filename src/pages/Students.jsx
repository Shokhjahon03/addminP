...
let [x,setX]=useState(0)
  ...
  return (
    <div>
            ...
            <TableBody>
              {students.map((student) => (
                ...
                >
                  ...
                  <TableCell>
                    <Actions editetitemsID={editetitemsID} daletItimes={daletItimes} id={student.id} />
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
      ...
      {edit?<Edit edit={edit} setEdit={setEdit} x={x} setX={setX} itemsID={itemsID}/>:""}
    </div>
  );
};
